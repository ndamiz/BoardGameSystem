...
public class StatsPageSellGame extends JPanel implements ActionListener{
	MainFrame mainFrm;
    ...
    JPanel BigLblpane=new JPanel();    JLabel BigLbl3=new JLabel("판매용 보드게임");
    ...
    //테이블에 들어갈 라벨들
		    String TStatsLbl3[]= {"NO.","     게임명    ", "단가" , "수량" , " 판매금액"};
    ...
    public StatsPageSellGame() {}
	
	public StatsPageSellGame(MainFrame mainFrm) {
...
////////////////////////////
       ...
       //라벨패널 임의 배치,패널에 라벨 추가
				BigLbl3.setFont(fnt);
		    	add(BigLblpane);  BigLblpane.setBounds(10, 3, 150, 30);    BigLblpane.add(BigLbl3);  

	  //정보 테이블	
				model1=new DefaultTableModel(TStatsLbl3,0);
...
/*
	...
	*/
	...
	public void getdataAll() {
						...
						DBDAO dao=new DBDAO();
						List<DBVO>lst=dao.DBAllSelect(start, end);
						setNewTableList(lst);
...
public void setNewTableList(List<DBVO> lst) {
	 ...
	 for(int i=0; i<lst.size(); i++) {
			...
			Object[]d= {i+1,vo.getGamename(),vo.getGameprice(),vo.getOrdercount(),vo.getTotal()
			};
